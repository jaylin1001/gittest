		...
		<table class="table table-bordered">
			<tr>
				...
				<td rowspan="2" style="text-align: center;">
					<div>승인자1</div>
					<a href="addgrantor.jsp" class="btn btn-default"
					data-toggle="modal" data-target="#myModal" id="addgrantor">선택</a>
				</td>
				<td rowspan="2" style="text-align: center;">
					<div>승인자2</div> <a href="addgrantor.jsp" class="btn btn-default"
					data-toggle="modal" data-target="#myModal" id="addgrantor">선택</a>
				</td>
				<td rowspan="2" style="text-align: center;">
					<div>승인자3</div> <a href="addgrantor.jsp" class="btn btn-default"
					data-toggle="modal" data-target="#myModal" id="addgrantor">선택</a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3"><input class="form-control" type="text">
					<button class="btn btn-default">수신부서지정</button>
...
<script>
	$(function() {
		...
		$('.form-group').on('click', '#go', function() {
			$.ajax({
				method : 'POST',
				url : '../docreadgian.do',
				data : {
